...
1.  Busca em Tempo Real: Integração com Jikan API via FeignClient para recuperação de dados de animes, personagens e episódios.

2. Arquitetura Robusta: Backend estruturado sob os princípios SOLID e padrão MVC.


3. Interface Adaptável: Frontend dinâmico com Angular, focado em performance e experiência do usuário Mobile First.
